...
import com.robson.cursomc.domain.ItemPedido;
...
import com.robson.cursomc.repositories.ItemPedidoRepository;
...
public class DBService {
	...
	@Autowired
	private CategoriaRepository categoriaRespositoy;
	@Autowired
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		categoriaRespositoy.saveAll(Arrays.asList(cat1, cat2, cat3, cat4, cat5, cat6, cat7));
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "robsonsilv410@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "robsonsilv4@alu.ufc.br", "31628382740", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
